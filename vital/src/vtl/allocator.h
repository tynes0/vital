#pragma once
#ifndef _VITAL_ALLOCATOR_
#define _VITAL_ALLOCATOR_
...
public:
	...
	{
		::new (static_cast<void*>(p)) U(vtl::forward<Args>(args)...);
	}
...
struct alloc_construct_ptr
{
	...
	VTL_NODISCARD constexpr pointer release() noexcept
	{
