#pragma once
#ifndef _VITAL_BITSET_
#define _VITAL_BITSET_
...
public:
    VTL_CONSTEXPR23 ~bitset_reference() noexcept {}

    VTL_CONSTEXPR23 bitset_reference& operator=(const bool _Val) noexcept
    {
        m_bitset->set_unchecked(m_pos, _Val);
        return *this;
    }

    VTL_CONSTEXPR23 bitset_reference& operator=(const bitset_reference& _Bitref) noexcept
    {
        m_bitset->set_unchecked(m_pos, static_cast<bool>(_Bitref));
        return *this;
    }

    VTL_CONSTEXPR23 bitset_reference& flip() noexcept
    {
        m_bitset->flip_unchecked(m_pos);
        return *this;
    }

    VTL_NODISCARD VTL_CONSTEXPR23 bool operator~() const noexcept
    {
        return !m_bitset->subscript(m_pos);
    }

    VTL_CONSTEXPR23 operator bool() const noexcept
    {
        return m_bitset->subscript(m_pos);
    }

private:
    VTL_CONSTEXPR23 bitset_reference() noexcept : m_bitset(nullptr), m_pos(0) {}

    VTL_CONSTEXPR23 bitset_reference(bitset<_Bits>& _Bitset, const size_t _Pos) noexcept : m_bitset(&_Bitset), m_pos(_Pos) {}
...
template <size_t _Bits>
class bitset_iterator : public iterator_base<bool>
{
public:
    ...
    VTL_CONSTEXPR17 bitset_iterator(bitset<_Bits>* data = nullptr, size_type offset = 0) : m_ptr(data), m_offset(offset) {}
     
    VTL_CONSTEXPR17 bitset_iterator(const bitset_iterator& other) : m_ptr(other.m_ptr), m_offset(other.m_offset) {}
     
    VTL_CONSTEXPR17 ~bitset_iterator() {}
    ...
    VTL_CONSTEXPR17 bitset_iterator& operator++()
    {
        ++m_offset;
        return *this;
    }

    VTL_CONSTEXPR17 bitset_iterator operator++(int)
    {
    ...
    VTL_CONSTEXPR17 bool operator==(const bitset_iterator& other) const
    {
        return ((m_ptr == other.m_ptr) && (m_offset == other.m_offset));
    }

    VTL_CONSTEXPR17 bool operator==(bitset_iterator&& other) const
    {
    ...
    VTL_CONSTEXPR17 bitset_iterator operator+(size_type n) const
    {
...
template <size_t _Bits>
class bitset_const_iterator : public iterator_base<const bool>
{
public:
    ...
    VTL_CONSTEXPR17 bitset_const_iterator(const bitset<_Bits>* const data = nullptr, size_type offset = 0) : m_ptr(data), m_offset(offset) {}

    VTL_CONSTEXPR17 bitset_const_iterator(const bitset_const_iterator& other) : m_ptr(other.m_ptr), m_offset(other.m_offset) {}

    VTL_CONSTEXPR17 ~bitset_const_iterator() {}
    ...
    VTL_CONSTEXPR17 bitset_const_iterator& operator++()
    {
        ++m_offset;
        return *this;
    }

    VTL_CONSTEXPR17 bitset_const_iterator operator++(int)
    {
    ...
    VTL_CONSTEXPR17 bool operator==(const bitset_const_iterator& other) const
    {
        return ((m_ptr == other.m_ptr) && (m_offset == other.m_offset));
    }

    VTL_CONSTEXPR17 bool operator==(bitset_const_iterator&& other) const
    {
        bool res = ((m_ptr == other.m_ptr) && (m_offset == other.m_offset));
        return res;
    }
    ...
    VTL_CONSTEXPR17 bitset_const_iterator operator+(size_type n) const
    {
...
public:
    ...
    using reverse_iterator          = vtl::reverse_iterator<bitset_iterator<_Bits>>;
    using const_reverse_iterator    = vtl::reverse_iterator<bitset_const_iterator<_Bits>>;
...
#pragma warning(pop)
    ...
    VTL_NODISCARD constexpr bool operator[](size_t position) const
    {
        return _Bits <= position ? (validate(position), false) : subscript(position);
    }

    VTL_NODISCARD VTL_CONSTEXPR23 reference operator[](const size_t position) noexcept
    {
        validate(position);
    ...
    VTL_CONSTEXPR23 void construct(const _Elem* const ptr, size_t count, const _Elem elem0, const _Elem elem1)
    {
        if (count > _Bits)
        {
    ...
    VTL_CONSTEXPR20 explicit bitset(const std::basic_string<_Elem, _Traits, _Alloc>& str, typename std::basic_string<_Elem, _Traits, _Alloc>::size_type position = 0, typename std::basic_string<_Elem, _Traits, _Alloc>::size_type count = std::basic_string<_Elem, _Traits, _Alloc>::npos, _Elem elem0 = static_cast<_Elem>('0'), _Elem elem1 = static_cast<_Elem>('1'))
    {
    ...
    VTL_CONSTEXPR23 explicit bitset(const _Elem* str, typename std::basic_string<_Elem>::size_type count = std::basic_string<_Elem>::npos, _Elem elem0 = static_cast<_Elem>('0'), _Elem elem1 = static_cast<_Elem>('1'))
    {
    ...
    VTL_CONSTEXPR23 bitset& operator&=(const bitset& right) noexcept
    {
    ...
    VTL_CONSTEXPR23 bitset& operator<<=(size_t position) noexcept
    {
    ...
    VTL_CONSTEXPR23 bitset& set() noexcept
    {
#if _VTL_HAS_CPP_VERSION(23)
        if (vtl::is_constant_evaluated())
        {
    ...
    VTL_CONSTEXPR23 bitset& set(const size_t position, bool value = true)
    {
        if (_Bits <= position)
            throw_oran();
    ...
    VTL_CONSTEXPR23 bitset& reset() noexcept
    {
#if _VTL_HAS_CPP_VERSION(23)
        if (vtl::is_constant_evaluated())
        {
    ...
    VTL_CONSTEXPR23 bitset& reset(const size_t position)
    {
        return set(position, false);
    }

    VTL_NODISCARD VTL_CONSTEXPR23 bitset operator~() const noexcept
    {
        bitset temp = *this;
        temp.flip();
        return temp;
    ...
    VTL_CONSTEXPR23 bitset& flip() noexcept
    {
        for (size_t wpos = 0; wpos <= words; ++wpos)
    ...
    VTL_CONSTEXPR23 bitset& flip(const size_t position)
    {
        if (_Bits <= position)
            throw_oran();
    ...
    VTL_NODISCARD VTL_CONSTEXPR23 unsigned long to_ulong() const noexcept(_Bits <= 32)
    {
    ...
    VTL_NODISCARD VTL_CONSTEXPR23 unsigned long long to_ullong() const noexcept(_Bits <= 64)
    {
        constexpr bool bits_zero = _Bits == 0;
        constexpr bool bits_large = _Bits > 64;
        if constexpr (bits_zero)
    ...
    VTL_NODISCARD VTL_CONSTEXPR23 std::basic_string<_Elem, _Traits, _Alloc> to_string(const _Elem elem0 = static_cast<_Elem>('0'), const _Elem elem1 = static_cast<_Elem>('1')) const
    {
    ...
    VTL_NODISCARD VTL_CONSTEXPR23 bool operator==(const bitset& right) const noexcept
    {
#if _VTL_HAS_CPP_VERSION(23)
        if (vtl::is_constant_evaluated())
        {
    ...
    VTL_NODISCARD bool operator!=(const bitset& right) const noexcept 
    {
        return !(*this == right);
    }
#endif // !_VTL_HAS_CPP_VERSION(23)

    VTL_NODISCARD VTL_CONSTEXPR23 bool test(const size_t position) const
    {
        if (_Bits <= position)
            throw_oran();
    ...
    VTL_NODISCARD VTL_CONSTEXPR23 bool any() const noexcept
    {
        for (size_t wpos = 0; wpos <= words; ++wpos)
            if (m_data[wpos] != 0)
                return true;
    ...
    VTL_NODISCARD VTL_CONSTEXPR23 bool none() const noexcept
    {
        return !any();
    }

    VTL_NODISCARD VTL_CONSTEXPR23 bool all() const noexcept
    {
    ...
    VTL_NODISCARD VTL_CONSTEXPR23 bitset operator<<(const size_t position) const noexcept
    {
        bitset temp = *this;
        temp <<= position;
        return temp;
    ...
    VTL_NODISCARD _Ty get_word(size_t wpos) const noexcept
    {
        return m_data[wpos];
    }

    VTL_NODISCARD VTL_CONSTEXPR23 iterator begin() noexcept
    {
        return iterator(this, 0);
    }

    VTL_NODISCARD VTL_CONSTEXPR23 iterator end() noexcept
    {
        return iterator(this, _Bits);
    }

    VTL_NODISCARD VTL_CONSTEXPR23 const_iterator begin() const noexcept
    {
        return const_iterator(this, 0);
    }

    VTL_NODISCARD VTL_CONSTEXPR23 const_iterator end() const noexcept
    {
        return const_iterator(this, _Bits);
    }

    VTL_NODISCARD VTL_CONSTEXPR23 const_iterator cbegin() const noexcept
    {
        return const_iterator(this, 0);
    }

    VTL_NODISCARD VTL_CONSTEXPR23 const_iterator cend() const noexcept
    {
        return const_iterator(this, _Bits);
    }

    VTL_NODISCARD VTL_CONSTEXPR23 reverse_iterator rbegin() noexcept
    {
        return reverse_iterator(end());
    }

    VTL_NODISCARD VTL_CONSTEXPR23 reverse_iterator rend() noexcept
    {
        return reverse_iterator(begin());
    }

    VTL_NODISCARD VTL_CONSTEXPR23 const_reverse_iterator crbegin() const noexcept
    {
        return reverse_iterator(cend());
    }

    VTL_NODISCARD VTL_CONSTEXPR23 const_reverse_iterator crend() const noexcept
    {
...
private:
    VTL_CONSTEXPR23 void trim() noexcept
    {
    ...
    VTL_CONSTEXPR23 bitset& set_unchecked(const size_t position, const bool value) noexcept
    {
    ...
    VTL_CONSTEXPR23 bitset& flip_unchecked(const size_t position) noexcept
    {
        m_data[position / bits_per_word] ^= _Ty{ 1 } << position % bits_per_word;
        return *this;
    }

    VTL_NORETURN void throw_inv_arg() const
    {
        std::_Xinvalid_argument("invalid whip::bitset char");
    }

    VTL_NORETURN void throw_oflow() const
    {
        std::_Xoverflow_error("whip::bitset overflow");
    }

    VTL_NORETURN void throw_oran() const
    {
...
template <size_t _Bits>
VTL_NODISCARD VTL_CONSTEXPR23 bitset_iterator<_Bits> begin(bitset<_Bits>& bits) noexcept
{
    return { &bits, 0 };
}

template <size_t _Bits>
VTL_NODISCARD VTL_CONSTEXPR23 bitset_iterator<_Bits> end(bitset<_Bits>& bits) noexcept
{
    return { &bits, _Bits };
}

template <size_t _Bits>
VTL_NODISCARD VTL_CONSTEXPR23 bitset<_Bits> operator&(const bitset<_Bits>& left, const bitset<_Bits>& right)
{
...
{
    VTL_NODISCARD size_t operator()(const bitset<_Bits>& key_value) const noexcept 
    {
