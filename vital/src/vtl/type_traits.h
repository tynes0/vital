#pragma once
#ifndef _VITAL_TYPE_TRAITS_
#define _VITAL_TYPE_TRAITS_
...
struct integral_constant
{
	...
	VTL_NODISCARD constexpr type operator()() { return value; }
};
...
template <class _Ty>
using identity_t _VTL_MSVC_KNOWN_SEMANTICS = typename identity<_Ty>::type;
...
VTL_INLINE constexpr bool is_same_v = false;

template <class _Ty>
VTL_INLINE constexpr bool is_same_v<_Ty, _Ty> = true;

template <class _Ty1, class _Ty2>
struct is_same : bool_constant<is_same_v<_Ty1, _Ty2>> {};

template <class>
VTL_INLINE constexpr bool is_array_v = false;

template <class _Ty, size_t n>
VTL_INLINE constexpr bool is_array_v<_Ty[n]> = true;

template <class _Ty>
VTL_INLINE constexpr bool is_array_v<_Ty[]> = true;

template <class _Ty>
struct is_array : bool_constant<is_array_v<_Ty>> {};

template <class>
VTL_INLINE constexpr bool is_bounded_array_v = false;

template <class _Ty, size_t _Nx>
VTL_INLINE constexpr bool is_bounded_array_v<_Ty[_Nx]> = true;

template <class _Ty>
struct is_bounded_array : bool_constant<is_bounded_array_v<_Ty>> {};

template <class>
VTL_INLINE constexpr bool is_unbounded_array_v = false;

template <class _Ty>
VTL_INLINE constexpr bool is_unbounded_array_v<_Ty[]> = true;

template <class _Ty>
struct is_unbounded_array : bool_constant<is_unbounded_array_v<_Ty>> {};

template <class>
VTL_INLINE constexpr bool is_lvalue_reference_v = false;

template <class _Ty>
VTL_INLINE constexpr bool is_lvalue_reference_v<_Ty&> = true;

template <class _Ty>
struct is_lvalue_reference : bool_constant<is_lvalue_reference_v<_Ty>> {};

template <class>
VTL_INLINE constexpr bool is_rvalue_reference_v = false;

template <class _Ty>
VTL_INLINE constexpr bool is_rvalue_reference_v<_Ty&&> = true;

template <class _Ty>
struct is_rvalue_reference : bool_constant<is_rvalue_reference_v<_Ty>> {};

template <class>
VTL_INLINE constexpr bool is_reference_v = false;

template <class _Ty>
VTL_INLINE constexpr bool is_reference_v<_Ty&> = true;
...
template <class _Ty>
VTL_INLINE constexpr bool is_pointer_v = false;

template <class _Ty>
VTL_INLINE constexpr bool is_pointer_v<_Ty*> = true;

template <class _Ty>
struct is_pointer : bool_constant<is_pointer_v<_Ty>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_empty_v = (sizeof(_Ty) == 0) || (sizeof(_Ty) == 1);

template <class _Ty>
struct is_empty : bool_constant<is_empty_v<_Ty>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_final_v = __isfinal(_Ty);

template <class _Ty>
struct is_final : bool_constant<is_final_v<_Ty>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_void_v = is_same_v<remove_cv_t<_Ty>, void>;
...
template <class _Ty>
VTL_INLINE constexpr bool has_value_type_v = has_value_type<_Ty>::value;

template <class _Ty>
struct has_difference_type : public detail_type_traits::has_difference_type_helper<_Ty> {};

template <class _Ty>
VTL_INLINE constexpr bool has_difference_type_v = has_difference_type<_Ty>::value;

template <class _Ty>
struct has_size_type : public detail_type_traits::has_size_type_helper<_Ty> {};

template <class _Ty>
VTL_INLINE constexpr bool has_size_type_v = has_size_type<_Ty>::value;

template <class _Ty>
struct has_pointer_type : public detail_type_traits::has_pointer_type_helper<_Ty> {};

template <class _Ty>
VTL_INLINE constexpr bool has_pointer_type_v = has_pointer_type<_Ty>::value;

template <class _Ty>
struct has_reference_type : public detail_type_traits::has_reference_type_helper<_Ty> {};

template <class _Ty>
VTL_INLINE constexpr bool has_reference_type_v = has_reference_type<_Ty>::value;
...
template <class... _Traits>
VTL_INLINE constexpr bool disjunction_v = disjunction<_Traits...>::value;

template <class _Ty, class... _Types>
VTL_INLINE constexpr bool is_any_of_v = disjunction_v<is_same<_Ty, _Types>...>;

template <class _From, class _To>
VTL_INLINE constexpr bool is_convertible_v = __is_convertible_to(_From, _To);
...
template <typename Base, typename Derived>
VTL_INLINE constexpr bool is_base_of_v = is_base_of<Base, Derived>::value;

template <class _Ty>
VTL_INLINE constexpr bool is_trivial_v = __is_trivially_constructible(_Ty) && __is_trivially_copyable(_Ty);

template <class _Ty>
struct is_trivial : bool_constant<is_trivial_v<_Ty>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_destructible_v = __is_destructible(_Ty);

template <class _Ty>
struct is_destructible : bool_constant<is_destructible_v<_Ty>> {};

template <class _Ty, class... _Args>
VTL_INLINE constexpr bool is_trivially_constructible_v = __is_trivially_constructible(_Ty, _Args...);

template <class _Ty, class... _Args>
struct is_trivially_constructible : bool_constant<is_trivially_constructible_v<_Ty, _Args...>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_trivially_copy_constructible_v = __is_trivially_constructible(_Ty, add_lvalue_reference_t<const _Ty>);

template <class _Ty>
struct is_trivially_copy_constructible : bool_constant<is_trivially_constructible_v<_Ty, add_lvalue_reference_t<const _Ty>>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_trivially_default_constructible_v = __is_trivially_constructible(_Ty);

template <class _Ty>
struct is_trivially_default_constructible : bool_constant<is_trivially_default_constructible_v<_Ty>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_trivially_move_constructible_v = __is_trivially_constructible(_Ty, _Ty);

template <class _Ty>
struct is_trivially_move_constructible : bool_constant<is_trivially_move_constructible_v<_Ty>> {};

template <class _To, class _From>
VTL_INLINE constexpr bool is_trivially_assignable_v = __is_trivially_assignable(_To, _From);

template <class _To, class _From>
struct is_trivially_assignable : bool_constant<is_trivially_assignable_v<_To, _From>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_trivially_copy_assignable_v = __is_trivially_assignable(add_lvalue_reference_t<_Ty>, add_lvalue_reference_t<const _Ty>);

template <class _Ty>
struct is_trivially_copy_assignable : bool_constant<is_trivially_copy_assignable_v<_Ty>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_trivially_move_assignable_v = __is_trivially_assignable(add_lvalue_reference_t<_Ty>, _Ty);

template <class _Ty>
struct is_trivially_move_assignable : bool_constant<is_trivially_move_assignable_v<_Ty>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_trivially_destructible_v = __is_trivially_destructible(_Ty);
...
template <class _Ty>
VTL_INLINE constexpr bool is_nothrow_default_constructible_v = __is_nothrow_constructible(_Ty);

template <class _Ty>
struct is_nothrow_default_constructible : bool_constant<is_nothrow_default_constructible_v<_Ty>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_nothrow_move_constructible_v = __is_nothrow_constructible(_Ty, _Ty);
...
template <class _Ty>
VTL_INLINE constexpr bool is_nothrow_copy_assignable_v = __is_nothrow_assignable(add_lvalue_reference_t<_Ty>, add_lvalue_reference_t<const _Ty>);

template <class _Ty>
struct is_nothrow_copy_assignable : bool_constant<is_nothrow_copy_assignable_v<_Ty>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_nothrow_move_assignable_v = __is_nothrow_assignable(add_lvalue_reference_t<_Ty>, _Ty);

template <class _Ty>
struct is_nothrow_move_assignable : bool_constant<is_nothrow_move_assignable_v<_Ty>> {};

template <class _Ty>
VTL_INLINE constexpr bool is_nothrow_destructible_v = __is_nothrow_destructible(_Ty);
...
VTL_INLINE constexpr size_t extent_v = 0;

template <class _Ty, size_t _Nx>
VTL_INLINE constexpr size_t extent_v<_Ty[_Nx], 0> = _Nx;

template <class _Ty, unsigned int _Ix, size_t _Nx>
VTL_INLINE constexpr size_t extent_v<_Ty[_Nx], _Ix> = extent_v<_Ty, _Ix - 1>;

template <class _Ty, unsigned int _Ix>
VTL_INLINE constexpr size_t extent_v<_Ty[], _Ix> = extent_v<_Ty, _Ix - 1>;
...
template <class _Ty1, class _Ty2>
VTL_INLINE constexpr bool is_swappable_with_v = conjunction_v<std::_Swappable_with_helper<_Ty1, _Ty2>, std::_Swappable_with_helper<_Ty2, _Ty1>>;

template <class _Ty>
struct is_swappable : std::_Is_swappable<_Ty>::type {};

template <class _Ty>
VTL_INLINE constexpr bool is_swappable_v = std::_Is_swappable<_Ty>::value;

template <class _Ty1, class _Ty2>
struct is_nothrow_swappable_with : std::_Is_nothrow_swappable_with<_Ty1, _Ty2>::type {};

template <class _Ty1, class _Ty2>
VTL_INLINE constexpr bool is_nothrow_swappable_with_v = std::_Is_nothrow_swappable_with<_Ty1, _Ty2>::value;

template <class _Ty>
struct is_nothrow_swappable : std::_Is_nothrow_swappable<_Ty>::type {};

template <class _Ty>
VTL_INLINE constexpr bool is_nothrow_swappable_v = std::_Is_nothrow_swappable<_Ty>::value;
