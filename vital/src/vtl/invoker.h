#pragma once
#ifndef _VITAL_INVOKER_
#define _VITAL_INVOKER_
...
namespace detail_invoker
{
    ...
    template <class _Callable>
    using decltype_invoke_zero = decltype(vtl::declval<_Callable>()());

    template <class _Callable>
    struct invoke_traits_zero<void_t<decltype_invoke_zero<_Callable>>, _Callable> 
        : invoke_traits_common<decltype_invoke_zero<_Callable>, noexcept(vtl::declval<_Callable>()())> {};
    ...
    template <class _Callable, class _Ty1, class... _Types2>
    using decltype_invoke_nonzero = decltype(invoker1<_Callable, _Ty1>::call(vtl::declval<_Callable>(), vtl::declval<_Ty1>(), vtl::declval<_Types2>()...));

    template <class _Callable, class _Ty1, class... _Types2>
    struct invoke_traits_nonzero<void_t<decltype_invoke_nonzero<_Callable, _Ty1, _Types2...>>, _Callable, _Ty1, _Types2...> 
        : invoke_traits_common<decltype_invoke_nonzero<_Callable, _Ty1, _Types2...>, noexcept(invoker1<_Callable, _Ty1>::call(vtl::declval<_Callable>(), vtl::declval<_Ty1>(), vtl::declval<_Types2>()...))> {};
...
template <class _Callable, class... _Args>
VTL_INLINE constexpr bool is_invocable_v = detail_invoker::select_invoke_traits<_Callable, _Args...>::is_invocable::value;

template <class _Callable, class... _Args>
struct is_nothrow_invocable : detail_invoker::select_invoke_traits<_Callable, _Args...>::is_nothrow_invocable {};

template <class _Callable, class... _Args>
VTL_INLINE constexpr bool is_nothrow_invocable_v = detail_invoker::select_invoke_traits<_Callable, _Args...>::is_nothrow_invocable::value;

template <class _Rx, class _Callable, class... _Args>
struct is_invocable_r : detail_invoker::is_invocable_r_<_Rx, _Callable, _Args...> {};

template <class _Rx, class _Callable, class... _Args>
VTL_INLINE constexpr bool is_invocable_r_v = detail_invoker::is_invocable_r_<_Rx, _Callable, _Args...>::value;

template <class _Rx, class _Callable, class... _Args>
struct is_nothrow_invocable_r : detail_invoker::select_invoke_traits<_Callable, _Args...>::template is_nothrow_invocable_r<_Rx> {};

template <class _Rx, class _Callable, class... _Args>
VTL_INLINE constexpr bool is_nothrow_invocable_r_v = detail_invoker::select_invoke_traits<_Callable, _Args...>::template is_nothrow_invocable_r<_Rx>::value;
