...
VTL_CONSTEXPR20 xoshiro256plus::xoshiro256plus(uint64_t seed) noexcept : m_state(split_mix64{seed}.generate_seed_sequence<4>()) {}

VTL_CONSTEXPR20 xoshiro256plus::xoshiro256plus(state_type state) noexcept :m_state(state) {}

VTL_CONSTEXPR20 xoshiro256plus::result_type xoshiro256plus::operator()() noexcept
{
...
VTL_CONSTEXPR20 void xoshiro256plus::jump() noexcept
{
    constexpr vtl::array<uint64_t, 4> jump_arr = { 0x180ec6d33cfd0aba, 0xd5a61266f0c9392c, 0xa9582618e03fc9aa, 0x39abdc4529b1661c };
    vtl::array<uint64_t, 4> s = { 0, 0, 0, 0 };
...
VTL_CONSTEXPR20 void xoshiro256plus::long_jump() noexcept
{
}
